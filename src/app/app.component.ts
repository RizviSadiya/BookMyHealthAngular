  ...
  get_doctor_category(){
    ...
    this.api.getapi("category").subscribe(res=>{
      if(res.status==1){
        ...
        this.doctor_category_list = this.all_category_list.filter(item => item.cate_type === '2');
        this.hospital_category_list = this.all_category_list.filter(item => item.cate_type === '3');
        this.treatment_category_list = this.all_category_list.filter(item => item.cate_type === '4');
